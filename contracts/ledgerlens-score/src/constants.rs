...
/// Alias for `MAX_FINALITY_BUFFER_SECS` under the "escrow" naming.
pub const MAX_ESCROW_HOLD_WINDOW_SECS: u64 = MAX_FINALITY_BUFFER_SECS;
...
/// Minimum allowed value for `set_param_change_delay` — 1 hour.
pub const MIN_PARAM_CHANGE_DELAY_SECS: u64 = 3_600;

/// Maximum allowed value for `set_param_change_delay` — 7 days.
